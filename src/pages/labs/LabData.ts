...
export const sqlInjectionLabs: Lab[] = [
  { 
    ...
    iframeSrc: '/labs/lab-sqli-1.html' // Nome correto do ficheiro
  },
  { 
    id: '2', 
    ...
    iframeSrc: '/labs/lab-sqli-2.html' // Nome correto do ficheiro
  },
  { 
    id: '3', 
    ...
    iframeSrc: '/labs/lab-sqli-3.html' // Nome correto do ficheiro
  },
];